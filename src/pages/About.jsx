...
import saif from '../assets/team/saif.jpg'

const TEAM = [
  {
    id: 't1',
    name: 'Md Sameer Sadar',
    role: 'Head of Team',
    bio: 'Enthusiast Developer, Working on the FrontEnd',
    img: sameer
  },
  {
    id: 't2',
  ...
  },
  {
    ...
    bio: 'Working on the chatBot with proper support',
    img: saif
  }
]
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <section className="rounded-lg p-6 bg-white dark:bg-gray-800/60 shadow">
        ...
        <p className="mt-3 text-gray-600 dark:text-gray-300">
          Remove barriers to quality education by building accessible, multilingual and
          low-bandwidth learning experiences.
        </p>
      </section>
      ...
      <section className="rounded-lg p-6 bg-white dark:bg-gray-800/60 shadow">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {TEAM.map(m => (
            <div
              key={m.id}
              className="p-4 rounded-lg ring-1 ring-gray-200 dark:ring-gray-700 hover:shadow-lg transition"
              data-team-name={m.name}
            >
